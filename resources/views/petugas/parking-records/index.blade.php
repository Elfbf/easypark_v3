...
@section('title', 'Catatan Parkir')
@section('page_title', 'Catatan Parkir')
...
@section('content')
    ...
    <nav style="display:flex;align-items:center;gap:6px;font-size:13px;margin-bottom:20px;">
        ...
        <span style="color:#D4D9E8;">/</span>
        <span style="color:#181D35;font-weight:600;">Catatan Parkir</span>
    </nav>

    {{-- ── Page Header ── --}}
    <div class="page-head">
        <div>
            <div class="page-title">Catatan Parkir</div>
            <div class="page-sub">Pantau seluruh riwayat aktivitas parkir kendaraan hari ini</div>
        </div>
    </div>
    ...
    {{-- ── Tabel Catatan Parkir ── --}}
    <div class="card">
        <div class="card-header" style="flex-wrap:wrap;gap:12px;">
            <div>
                <div class="card-title">Daftar Catatan Parkir Hari Ini</div>
                <div class="card-sub">{{ $parkingRecords->total() }} catatan ditemukan hari ini</div>
            </div>

            {{-- Filter Form --}}
            <form method="GET" action="{{ route('petugas.parking-records.index') }}"
                  id="filterForm"
        ...
        @if ($parkingRecords->isEmpty())
            <div style="padding:64px 24px;text-align:center;">
                ...
                <div style="font-family:'Syne',sans-serif;font-size:15px;font-weight:700;
                    ...
                    {{ ($search || $status) ? 'Tidak ada catatan yang cocok' : 'Belum ada catatan parkir hari ini' }}
                </div>
                <div style="font-size:13px;color:#8A93AE;line-height:1.6;">
                    ...
                    @else
                        Belum ada kendaraan yang tercatat masuk hari ini
                    @endif
                </div>
            </div>
        @else
    ...
    <div id="modalDetail"
        ...
        <div style="background:#fff;border-radius:20px;padding:32px;
                    width:100%;max-width:460px;box-shadow:0 24px 64px rgba(7,28,82,.18);margin:16px;">
    ...
    <div id="modalPhoto"
        ...
        <div style="background:#fff;border-radius:20px;padding:24px;
            ...
            <div style="font-family:'Syne',sans-serif;font-size:14px;font-weight:800;
                        color:#181D35;margin-bottom:4px;">Foto Wajah</div>
