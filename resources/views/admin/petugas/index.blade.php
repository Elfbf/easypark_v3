                ...
                <tbody>
                    @forelse($petugas as $index => $p)
                        <tr id="row-{{ $p->id }}"
                            ...
                            data-nim="{{ strtolower($p->nim_nip ?? '') }}"
                            data-status="{{ $p->is_active ? '1' : '0' }}"
            ...
            <form action="{{ route('admin.petugas.store') }}" method="POST"
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <input type="text" name="name" id="addName"
                        placeholder="Nama lengkap petugas" autocomplete="off" required
                        value="{{ old('name') }}"
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <input type="text" name="nim_nip" id="addNimNip"
                        placeholder="Nomor identitas petugas" autocomplete="off" required
                        value="{{ old('nim_nip') }}"
                        style="width:100%;height:42px;border:1.5px solid #D4D9E8;border-radius:10px;
                               padding:0 14px;outline:none;font-family:'DM Sans',sans-serif;
                               font-size:13.5px;color:#181D35;background:#fff;
                ...
                <div style="margin-bottom:16px;">
                    ...
                    <div style="position:relative;">
                        ...
                        <button type="button" onclick="togglePassword('addPassword', 'eyeAdd')"
                            ...
                            <svg id="eyeAdd" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
